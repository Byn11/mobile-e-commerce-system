...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="admin/Admin!login" method="post">
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60d;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="userMsgDTO.userName" type="text" placeholder="账户" class="input-text size-L">
          <s:fielderror fieldName="userMsgDTO.userName" theme="simple" cssStyle="color:#FF0000;"></s:fielderror>
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="" name="userMsgDTO.userPassword" type="password" placeholder="密码" class="input-text size-L">
          <s:fielderror fieldName="userMsgDTO.userPassword" theme="simple" cssStyle="color:#FF0000;"></s:fielderror>
        </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <canvas id="canvas" width="100" height="43"></canvas></div>
      </div>
    ...
    $(function(){
        ...
        $(".btn").on('click',function(){
            ...
            if(val==''){
            	...
            	//window.location.href="/struts_project/error1.jsp";
                alert('验证码错误！请重新输入！');
                $("#code").val('');
                draw(show_num);
                return false; 
