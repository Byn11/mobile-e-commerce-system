...
<body>
<form action="user/User!adminSelectPage?userMsgDTO.powerId=0" method="post">
	<div class="page-container">
		<div>
			<s:hidden name="pageNumber" value="1" id="pageNumber"></s:hidden>
			<s:textfield cssClass="input-text" cssStyle="width:250px" placeholder="输入管理员姓名" name="userMsgDTO.userName"></s:textfield>
		...
		<table class="table table-border table-bordered table-bg">
			<thead>
				...
				<tr class="text-c">					
					...
					<th width="15%">管理员联系电话</th>
				</tr>
			</thead>
			<tbody>
				<s:if test="userList==null">
						<tr>
							<th scope="col" colspan="6">没有满足条件的管理员信息！</th>
						</tr>
					</s:if>
					<s:else>
						<s:iterator value="userList" var="user">
